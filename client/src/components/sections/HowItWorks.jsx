      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative animate-slide-up stagger-1">
            ...
            <div className="p-card p-6 sm:p-10">
               ...
               <div className="text-center mb-12">
                  <div className="text-[80px] sm:text-[120px] font-black text-blue-primary leading-none tracking-tighter mb-4 animate-scale-up">#08</div>
